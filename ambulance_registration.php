...
$sql1 = "SELECT user_name FROM `ambulance`";
$results1 = $con->query($sql1);


if(isset($_POST['ambulanceRegForm'])){
    //pr($_POST, true);
    ...
    while ($row = $results1->fetch_assoc()) {
      ...
      if ($row['user_name'] ==$username ){
        redirect('ambulance_registration.php', 'Username Already Exits', 'danger');
        break;
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 mb-5 form-content py-5">
              <form method="post" action="ambulance_registration.php">
                ...
                <div class="text-center my-3">
                  <input type="submit" value="Submit" name="ambulanceRegForm" class="btn btn-dark">
                </div>
              </form>
            </div>
          </div>
