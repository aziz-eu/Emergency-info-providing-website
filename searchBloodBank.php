          ...
          <div class="col-lg-6 d-block d-lg-flex">
            <div class="blook-bank-card propertiys">
              ...
              <ul>
                ...
                <li>Address : <?php echo $row['upazila'] ?> , <?php echo $row['city'] ?></li>
                <li>
                  Avaiable Blood Group : A+ : 3 unit A- : 2 unit...............
                </li>
                <li>Status : Replay with in a 5 Minite</li>
              </ul>
                      ...
                      <div class="modal-body">
                        ...
                        <form method="POST" action="./searchBloodBank.php">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" name="applicationForm" class="btn btn-primary">Save changes</button>
                          </div>
                        </form>
