...
if (isset($_POST['addNewPoliceStation'])) {
    //pr($_POST, true);
    ...
    $sql = "INSERT INTO `police`(`branch_name`, `phone`, `email`, `location`, `division`, `city`, `upazila`) VALUES ('$branch_name','$phone','$email','$address','$division','$city','$upazila')";

    if ($con->query($sql) == true) {
        redirect('police_add_new.php', 'Successfully Added');
    } else {
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block">
                        ...
                        Please carefully add police information. After filling the form, please recheck all the information again and keep all the information up-to-date.                    </p>
                    </div>
                    <div class="col-lg-6 mb-5 form-content py-5">
                        <form method="post" action="./police_add_new.php">
                            ...
                            <div class="text-center my-3">
                                <input type="submit" value="Submit" name="addNewPoliceStation" class="btn btn-dark">
                            </div>
                        </form>
                    </div>
                </div>
