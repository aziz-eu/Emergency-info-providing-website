...
if (isset($_GET['delete'])) {
    ...
    $sql = "DELETE FROM `fire_services` WHERE `id` = '$id'";
    // $result = mysqli_query($conn, $sql);
    if ($con->query($sql) == true) {
        //   $sql = "SELECT * FROM `blood_bank` WHERE id = '$id' LIMIT 1";
        //   $result = $con->query($sql);
        //   $_SESSION['user']  = $result->fetch_assoc();
        redirect('fire_service_info.php', 'Information Successfullay Updated.');
    } else {
...
if (isset($_POST['editFireSerInfo'])) {
    ...
    $id =  trim($_POST['fire_id']);

    $sql = "UPDATE `fire_services` SET `branch_name`='$branch_name',`phone`='$phone',`email`='$email',`location`='$address',`division`='$division',`city`='$city',`upazila`='$upazila' WHERE `id`= '$id' ";
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="./fire_service_info.php">
                                                    ...
                                                    <input type="hidden" name="fire_id" value="<?php echo $row['id'] ?>">
