...
if(isset($_POST['fireRegForm'])){
    ...
    $sql = "INSERT INTO `fire_service_registration` ( `branch_name`, `email`, `phone`, `address`, `division`, `city`, `upazila`, `username`, `password`) VALUES ('$branch_name', '$email', '$phone', '$address', '$division', '$city', '$upazila', '$username', '$password' ) ";
          ...
          <div class="row">
            <div class="col-lg-6 d-none d-lg-block">
              <div class="pt-2 position-fixed">
                ...
                <h2>Fire Service Registration</h2>
              </div>
            ...
            <div class="col-lg-6 mb-5 form-content py-5">
              <form method="post" action="./fire_S_registration.php">
                <label for="branch-name" class="form-lable">
                  Branch Name</label>
                <input
                  type="text"
                  class="form-control"
                ...
                <div class="text-center my-3">
                  <input type="submit" value="Submit" name="fireRegForm" class="btn btn-dark">
                </div>
              </form>
            </div>
          </div>
